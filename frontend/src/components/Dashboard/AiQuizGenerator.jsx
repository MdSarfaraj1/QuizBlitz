...
import { Brain, ChevronDown, ChevronRight, Plus, Download, Copy, Check } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
      <div className="p-6 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        ...
        <p className="mt-2 text-indigo-100">Create custom quizzes powered by AI</p>
      </div>

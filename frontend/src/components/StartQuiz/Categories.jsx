...
import { Search, Shuffle, Sparkles, Heart } from 'lucide-react'; // Added Heart icon
                            ...
                            <div className="text-center relative z-10 flex flex-col h-full">
                                ...
                                {userId && (
                                    <button
                                        ...
                                        title={favoriteCategoryIds.has(category._id) ? "Unmark as favorite" : "Mark as favorite"}
                                    >
                                        <Heart
                                            className={`w-5 h-5 transition-colors duration-200 ${
                                                favoriteCategoryIds.has(category._id) ? 'text-red-500 fill-current' : 'text-gray-400'
                                            }`}
                                        />
                                    </button>
                                )}

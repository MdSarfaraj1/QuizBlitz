...
const handleGoogleFailure = () => {
  ...
  return (
    <div className="login-background flex min-h-screen flex-col md:flex-row">
      ...
      <button
        onClick={() => navigate("/")}
        className="absolute top-6 left-6 z-20 bg-white/80 hover:bg-white text-gray-800 rounded-full p-2 shadow-md transition-colors duration-200"
        title="Go Back"
      >
        <ArrowLeft size={20} />
      </button>
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center p-12">
          <div className="w-full max-w-md text-white">
            ...
            <p className="text-lg opacity-90">
              Sign in to begin your quiz journey. Track your scores, challenge
              yourself, and improve with every attempt. Let’s test your
              knowledge and have some fun along the way!
            </p>
          </div>
        </div>
      </div>
